...
public class UserTrainingDAO {
    ...
    public int createTraining(int user_id, String name) throws SQLException {
    ...
    public List<UserTraining> getUserTrainings(int user_id) throws SQLException {
    ...
    public void deleteUserTraining(int id) throws SQLException {
